...
import 'package:snt_gold_project/Screens/Bottom%20Navigation%20Screen/Categories/category_productlist.dart';
import 'package:snt_gold_project/Screens/Bottom%20Navigation%20Screen/Home%20Screen/new_arrival.dart';
      ...
      child: Column(
        ...
        children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const ProductPage(categoryId: '1'),
                      ),
                    );
                  },
                  child: const CategoryItem(
                      label: 'Earrings', assetImage: 'assets/earrings.jpeg'),
                ),
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const ProductPage(categoryId: '2'),
                      ),
                    );
                  },
                  child: const CategoryItem(
                      label: 'Pendants', assetImage: 'assets/pendant.webp'),
                ),
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const ProductPage(categoryId: '3'),
                      ),
                    );
                  },
                  child: const CategoryItem(
                      label: 'Rings', assetImage: 'assets/gold_ring.webp'),
                ),
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const ProductPage(categoryId: '4'),
                      ),
                    );
                  },
                  child: const CategoryItem(
                      label: 'NosePins', assetImage: 'assets/nosepin_gold.png'),
                ),
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const ProductPage(categoryId: '5'),
                      ),
                    );
                  },
                  child: const CategoryItem(
                      label: 'Bracelets', assetImage: 'assets/bracelet1.png'),
                ),
          ...
          GridView.builder(
            ...
            itemCount: allnewproducts.length > 3 ? 3 : allnewproducts.length,
          ...
          GridView.builder(
            ...
            itemCount: allnewproducts.length > 1 ? 1 : allnewproducts.length,
            itemBuilder: (context, index) {
              return const NewArrivalsPage();
            },
          ),
        ],
      ),
